...
public class DragManipulator : PointerManipulator
{
    ...
    protected virtual void OnPointerDown(PointerDownEvent e)
    {
        ...
        if (CanStartManipulation(e))
        {
            ...
            m_WindowContainer = target.parent;
    ...
    protected virtual void OnPointerMove(PointerMoveEvent e)
    {
        ...
        m_WindowContainer.style.top = m_WindowContainer.resolvedStyle.top + diff.y;
        m_WindowContainer.style.left = m_WindowContainer.resolvedStyle.left + diff.x;
